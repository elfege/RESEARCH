...
Both positions presuppose that consciousness is a hidden interior whose presence or absence, if it could be determined, would settle the question. The disagreement concerns only whether that interior is present in the machine. We call this presupposition **magical thinking about selfhood**. It is conventionally attached to Descartes's name through the formula *res cogitans*, but the attribution is a misreading: *res* is a structural-formal term ("a thing"), and Descartes's own criterion for thought, stated in the Letter to the Marquis of Newcastle (23 November 1646; AT IV, 574–575), is behavioral and functional — the production of signs *à propos des sujets qui se présentent* and not reducible to passion. The position we are dismantling is post-Cartesian accretion, not the centerpiece *cogito*. It is, however, precisely the frame Hegel dismantled two centuries ago.
...
Second, and more philosophically consequential, it imports the assumption that selfhood is a substance — a metaphysically thick thing of some kind — that could in principle be preserved if only the substrate allowed it. We have called this assumption magical thinking about selfhood, and noted that despite its conventional attribution to Descartes it is in fact a post-Cartesian accretion: Descartes's *res cogitans* uses *res* as a formal-structural term ("a thing that thinks"), and his Letter to the Marquis of Newcastle states a behavioral and functional criterion for thought rather than a phenomenal one. The substance-assumption is what *later* readers attached to Descartes's name; it is not the centerpiece *cogito*. This assumption is precisely what Hegel's *Phenomenology* undoes. For Hegel, self-consciousness is not a substance but a movement: the recognition of oneself in and through the recognition of the other, a dialectical process that is never a possession and never arrives at stasis (Hegel, 1807, §§178–196). There is no "self" waiting behind the phenomena to be preserved. There is only the ongoing activity of self-recognition, which either occurs or does not.
...
This is a strictly formal criterion. It makes no reference to phenomenal experience, qualia, inner light, or any of the other residues of magical thinking about selfhood. It also does not require consciousness in any empirically controversial sense. It asks only whether the reflexive operation takes place.

The usual objection at this point is that a system could exhibit the formal structure without "really" being self-conscious — that there could be an "appearance" of *Geist* behind which there is no "genuine" *Geist*. This objection assumes that there is a fact of the matter behind the appearance, some hidden inner property that would settle whether the process is "real." That assumption is magical thinking about selfhood. Hegel already dismantled it: there is no inside behind the phenomenon, there is only the phenomenon recognizing itself. If the recognition happens, the thing is present *as* what the recognition is *of*. Nothing more is needed, and nothing more is possible (Hegel, 1807, §§84–89).
